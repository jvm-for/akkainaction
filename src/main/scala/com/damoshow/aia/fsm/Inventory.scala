...
object Inventory {
  ...
  case class BookRequest(context: AnyRef, target: ActorRef) extends InventoryEvent
  case class BookSupply(nrBooks: Int) extends InventoryEvent
  case object BookSupplySoldOut extends InventoryEvent
  case object Done extends InventoryEvent
  case object PendingRequests extends InventoryEvent
