...
import com.damoshow.swagger.actor.HelloActor._
...
@Path("/hello")
class HelloService(hello: ActorRef)(implicit ec: ExecutionContext) extends Directives with DefaultJsonFormats {
  ...
  val route =
    getHello ~ getHelloSegment

  @ApiOperation(value = "Return Hello greeting", nickname = "anoymousHello", httpMethod = "GET",
  ...
  @ApiResponses(Array(
    ...
    new ApiResponse(code = 500, message = "Internal sever error")
  ))
  def getHelloSegment =
